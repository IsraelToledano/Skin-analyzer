...
const ISRAEL_PRODUCTS = () => {
  ...
  return [
    ...
    {id:19, genericName:"water gel moisturizer", brandName:"Beauty of Joseon Red Bean Water Gel", notes:"", session:"both", frequency:"daily", stepOrder:8, nextDate:t, isOneOff:false, scheduled:true},
    {id:20, genericName:"Sebo-controlling moisturizer / mattifying moisturizer", brandName:"La Roche-Posay Effaclar Mat", notes:"", session:"am", frequency:"daily", stepOrder:7, nextDate:t, isOneOff:false, scheduled:true},
